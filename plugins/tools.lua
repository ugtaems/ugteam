--Begin Tools.lua :)
local SUDO = (378362487,427703984) -- put Your ID here! <===
...
1, nil, send_file, '@ugtaim', dl_cb, nil)
	end
	if matches[1]:lower() == "sendplug" and matches[2] then
	    local plug = "./plugins/"..matches[2]..".lua"
		tdcli.sendDocument(msg.chat_id_, msg.id_,0, 
1, nil, plug, '@ugtaim', dl_cb, nil)
    end
  end
...
if matches[1] == "سودو" and is_sudo(msg) then
text = [[

🔰راهنمای  سودو برای مالکان اصلی ربات 🔰

➰شما میتوانید از '/' یا '!' یا '#' برای اجرای دستورات استفاده کنید.

➖➖➖➖➖➖➖➖➖➖
⭕️ اضافه کرده گروه به پنل مدریت
✔️ نصب
➖➖➖➖➖➖➖➖➖➖
⭕️ حذف گروه از پنل مدیریتی
❌ حذف
➖➖➖➖➖➖➖➖➖➖
  خارج شدن ربات از گروه
🔚 ترک 
➖➖➖➖➖➖➖➖➖➖
  بارگذاری مجدد همه پلاگین ها
⭕️ بارگذاری مجدد
➖➖➖➖➖➖➖➖➖➖
...
⭕️ adminlist 
➖➖➖➖➖➖➖➖➖➖
  فعال و غیر فعال کردن خارج شدن ربات
...
⭕️ تاریخ انقضا/GroupID
  تنظیم تاریخ انقضای گروه مورد نظر
⭕️ شارژ/GroupID/Number Of Days
➖➖➖➖➖➖➖➖➖➖

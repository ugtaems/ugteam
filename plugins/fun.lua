...
--------------------------------
  if matches[1] == 'rank' or matches[1] == 'Rank' or matches[1] == 'مقام من' then
    ...
    tdcli.sendDocument(msg.chat_id_, 0, 0, 1, nil, './Fun/sudo.webp', '', dl_cb, nil)
      return "*aشما  مالک اصلی  و سودو هستید *"
    elseif is_admin(msg) then
    tdcli.sendDocument(msg.chat_id_, 0, 0, 1, nil, './Fun/admin.webp', '', dl_cb, nil)
      return "*شما  ادمین  اصلی  و مدیر گروه هستی*"
    ...
    tdcli.sendDocument(msg.chat_id_, 0, 0, 1, nil, './Fun/mod.webp', '', dl_cb, nil)
      return "*شما  ادمین  دست یار  معاون هستید *"
    else
    tdcli.sendDocument(msg.chat_id_, 0, 0, 1, nil, './Fun/member.webp', '', dl_cb, nil)
      return "*شما  عضو عادی هستید *"
    end
  end
--------------------------------
if matches[1]:lower() == 'test' then
return tdcli.sendDocument(msg.chat_id_, 0, 0, 1, nil, './Fun/ping.gif', '@kingvan_bot', dl_cb, nil)
end
--------------------------------
...
local text = '*زمان:* _'..jdat.FAtime..'_\n*تاریخ :* _'..jdat.FAdate..'_\n🌹🌺🌺🌺🌺🌺🌺🌹\n*En Time:* _'..jdat.ENtime..'_\n🌹🌺🌺🌺🌺🌺🌺🌹\n *En Data:* _'..jdat.ENdate.. '_\n'
  tdcli.sendMessage(msg.chat_id_, 0, 1, text, 1, 'md')
	end
-----------------
  if matches[1] == 'me' or matches[1] == 'Me' or matches[1] == 'من' then
    if is_sudo(msg) then
      return "*یوزر نام :* @"..(check_markdown(msg.from.username) or 'No یوزر نام ').."\n🌹🌺🌺🌺🌺🌺🌺🌹\n*ایدی کاربری:* `"..msg.from.id.."`\n🌹🌺🌺🌺🌺🌺🌺🌹\n*سمت در گروه :* `مالک ربات👑`\n*پیام های ارسالی شما:* `"..user_info_msgs.."️`"
    elseif is_admin(msg) then
      return "*یوزر نام :* @"..(check_markdown(msg.from.username) or 'No یوزر نام ').."\n🌹🌺🌺🌺🌺🌺🌺🌹\n*ایدی کاربری:* `"..msg.from.id.."`\n🌹🌺🌺🌺🌺🌺🌺🌹\n*سمت در گروه :* `ادمین  ربات👮🏻`\n*پیام های ارسالی شما:* `"..user_info_msgs.."`"
    elseif is_owner(msg) then
      return "*یوزر نام :* @"..(check_markdown(msg.from.username) or 'No یوزر نام ').."\n🌹🌺🌺🌺🌺🌺🌺🌹\n*ایدی کاربری:* `"..msg.from.id.."`\n🌹🌺🌺🌺🌺🌺🌺🌹\n*سمت در گروه :* `مدیر گروه🎖`\n*پیام های ارسالی شما:* `"..user_info_msgs.."`"
    elseif is_mod(msg) then
      return "*یوزر نام :* @"..(check_markdown(msg.from.username) or 'No یوزر نام ').."\n🌹🌺🌺🌺🌺🌺🌺🌹\n*ایدی کاربری:* `"..msg.from.id.."`\n🌹🌺🌺🌺🌺🌺🌺🌹\n*سمت در گروه :* `معاون مدیر🏅`\n*پیام های ارسالی شما:* `"..user_info_msgs.."`"
    else
      return "*یوزر نام :* @"..(check_markdown(msg.from.username) or 'No یوزر نام ').."\n🌹🌺🌺🌺🌺🌺🌺🌹\n*ایدی کاربری:* `"..msg.from.id.."`\n🌹🌺🌺🌺🌺🌺🌺🌹\n*سمت در گروه :* `عضوعادی گروه😑`\n*پیام های ارسالی شما:* `"..user_info_msgs.."`"
    end
  end
 --------------------------------
...
--------------------------------
	if matches[1]:lower() == "photo" or  matches[1]:lower() == "Photo" or matches[1]:lower() == "عکس" then 
		...
		tdcli.sendPhoto(msg.to.id, 0, 0, 1, nil, file, "@kingvan_bot", dl_cb, nil)
	end
